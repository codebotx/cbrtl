---
author: Srijan Paul & Anubhab Patnaik
title: 'QTree'
date: "2023-02-14"
...
This post is taken from [fuzzymf's post](https://anubhavp.dev/blog/posts/qtree)
...
img.src = "/assets/images/qtree/cryptopunk.jpeg";
img.onload = () => {
...
The next task would be adding a subtle animation to reveal the image when the mouse hovers over the canvas. If you want to contribute, you can fork this repo and create a pull request.
